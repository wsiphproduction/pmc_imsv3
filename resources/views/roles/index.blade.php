            ...
            <div class="portlet light bordered">
                ...
                <div class="portlet-title" id="title">
                    <div class="caption">
                        ...
                        <span class="caption-subject font-blue-hoki bold uppercase"> List of Roles</span>
                    </div>
                    
                    @if($create)
                        <a href="{{ route('roles.create') }}" class="btn btn-info pull-right">Add Role</a>
                    @else
                        <button disabled class="btn btn-info pull-right">Add Role</button>
                    @endif 
                ...
                <table class="user_tbl table table-hover">
                    ...
                    <tbody>
                        ...
                        @empty
                            <tr><td colspan="3" class="text-center"> No Role Found </td></tr>
                        @endforelse
                    </tbody>
                </table>
            </div>
