    ...
    <div class="row">
        <div class="col-md-12 well">
            <form autocomplete="off" id="form" class="form-inline">
                ...
                <div class="form-group">
                    <input style="width: 100%;" name="to" id="to" class="form-control form-control-inline date-picker" type="text" data-date-format="yyyy-mm-dd" data-date-end-date="+0d" value="{{ app('request')->input('to') }}" placeholder="Date To" />
                </div>
                ...
                <div class="portlet-body">
                    <div class="table-responsive">
                        <table class="table table-striped table-bordered table-advance table-hover">
                            ...
                            <tbody>
                                @php $row = 1; $incoterms_exception = ['EXW','CPT','CIP','CIF']; @endphp
                                @forelse($collection as $data)
                                    @php
                                        $y = 0;
                                        if(in_array($data->incoterms, $incoterms_exception)){
                                            $logistics = \App\logistics::where('poId',$data->id)->orderBy('id','desc')->first();
                                            if(empty($logistics)){
                                                $y = 1;
                                            }
                                            else{
                                                if($data->incoterms == 'CIF'){
                                        ...
                                        $delivery_balance = \App\logistics::delivery_balance($data->id);
