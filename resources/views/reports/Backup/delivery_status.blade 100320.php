    ...
    <div class="row">
        <div class="col-md-12 well">
            <form autocomplete="off" id="form" class="form-inline">
                ...
                <a href="{{ route('export.delivery-status',[$status]) }}" style="margin-right: 5px;" class="btn purple pull-right">Exportss</a>
                @else
                <a href="{{ route('export.deliveries') }}" style="margin-right: 5px;" class="btn purple pull-right">Exports</a>
                @endif
            </form>
        </div>
    </div> 
