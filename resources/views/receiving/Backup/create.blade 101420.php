                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input required type="number" class="form-control text-right input-lg" name="drrAmount" id="drrAmount" step="0.01" value="0.00" max="{{ \App\PO::drrAmountBalance($shipment->poId) }}">
