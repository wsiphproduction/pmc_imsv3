    ...
    <div class="row">
        ...
        <div class="col-md-8">
            <form autocomplete="off" action="{{ route('drr.store') }}" method="POST" id="formid" enctype="multipart/form-data">
                @csrf
                <input type="hidden" name="delivery_term" value="{{ $po->delivery_term }}">
                ...
                <div class="portlet light bordered">
                    <div class="portlet-title">
                        <div class="caption">
                            ...
                            <span class="caption-subject font-red-sunglo bold uppercase">PO# {{ $po->poNumber }}</span>
                        </div>
                    </div>
                    <div class="portlet-body form">
                        <div class="form-body">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input name="waybill" readonly type="text" class="form-control input-lg" value="services">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input required type="number" class="form-control text-right input-lg" name="drrAmount" id="drrAmount" step="0.01" value="0.00" max="{{ \App\PO::drrAmountBalance($po->id) }}">
                                        <span class="text-danger">Remaining DRR Amount: {{ \App\PO::drrAmountBalance($po->id) }}</span>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input required type="number" class="form-control text-right input-lg" name="drrQty" id="drrQty" step="0.01" value="0.00" max="{{\App\PO::DeliveryBalanceStatic($po->id) }}">
                                        <span class="text-danger">Remaining DRR Qty: {{ \App\PO::DeliveryBalanceStatic($po->id) }}</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Discrepancy File</label>
                                        <input type="file" id="uploadFile" class="form-control input-lg" name="uploadFile[]" multiple/>
                                    </div>
                                </div>
                            </div>
                            
                            @if($po->delivery_term == 'consignment items')
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <a href="{{ route('po.list') }}" class="btn btn-lg btn-default"><i class="fa fa-backward"></i> Back</a>
