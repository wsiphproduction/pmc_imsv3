        ...
        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 m-auto">
            <div class="card shadow">
                ...
                <div class="card-header">
                    <h5 class="card-title">Edit Port Name</h5>
                </div>

                <div class="card-body">
                    <div class="form-group">
                        <label for="title"> Port Name <span class="text-danger">*</span> </label>
                        <input type="text" name="Portname" id="Portname" class="form-control" placeholder="Enter Portname" value="@if(!empty($post)){{$post->Portname}}@else {{old('Portname')}} @endif" />
                        {!!$errors->first('Portname', '<small class="text-danger"> :message </small>') !!}
                    </div>
