...
// Export Routes
	Route::get('/export/delivery-status/{status}/{from}/{to}','ExportController@delivery_status')->name('export.delivery-status');
...
//Export
Route::get('/excel/payments/{from}/{to}','ExportController@exportPayments');
Route::get('/excel/payments/{supp}', 'ExportController@exportSupplier');
Route::get('/excel/deliveries/{from}/{to}', 'ExportController@exportUpcomingDeliveries');
Route::get('/excel/delivery/inProgress', 'ExportController@inProgress');
Route::get('/excel/delivery/inTransit', 'ExportController@inTransit');
Route::get('/excel/delivery/custom', 'ExportController@customClearing');
Route::get('/excel/delivery/pickUp', 'ExportController@forPickUp');
Route::get('/excel/delivery/delivered', 'ExportController@exportDelivered');
Route::get('/excel/delivery/open', 'ExportController@exportOpen');
Route::get('/excel/undelivered-po', 'ExportController@undeliveredPO');
Route::get('/excel/delivery/aging/{from}/{to}', 'ExportController@deliveryAging');
Route::get('/excel/po/{status}', 'ExportController@poStatus');
Route::get('/excel/waybill/{from}/{to}', 'ExportController@waybills');

Route::get('/excel/overdue-payments/{from}/{to}', 'ExportController@overduePayments');
Route::get('/excel/overdue-payments-with-supplier/{from}/{to}/{supplr}', 'ExportController@overduePaymentsWithSupplier');
Route::get('/excel/overdue-payables', 'ExportController@excelOverdue');
Route::get('/excel/overdue-po-supplier/{supplr}', 'ExportController@overduePaymentsSupplier');
Route::get('/excel/completion-date/{from}/{to}', 'ExportController@completionDate');




Route::get('/excel/unpaid-payments/{from}/{to}', 'ExportController@unpaidPayments');
Route::get('/excel/unpaid-payments-with-supplier/{from}/{to}/{supplr}', 'ExportController@unpaidPaymentsWithSupplier');
Route::get('/excel/unpaid-payables', 'ExportController@excelUnpaid');
Route::get('/excel/unpaid-payments-supplier/{supplr}', 'ExportController@unpaidPaymentsSupplier');

Route::get('/excel/overdue-po', 'ExportController@excelOverduePO');
Route::get('/excel/overdue-po/{from}/{to}', 'ExportController@overduePO');
Route::get('/excel/overdue-po-with-supplier/{from}/{to}/{supplr}', 'ExportController@overduePOWithSupplier');
Route::get('/excel/overdue-po-with-supplier/{supplr}', 'ExportController@overduePOSupplier');

Route::get('/excel/overdue-delivery-date/{from}/{to}', 'ExportController@excelOverdueDelivery');
Route::get('/excel/overdue-delivery-supplier/{supplier}', 'ExportController@excelOverdueSupplierDelivery');
Route::get('/excel/overdue-delivery-with-supplier/{from}/{to}/{supplier}', 'ExportController@excelOverdueSupplierDeliveryDate');
