                              ...
                              <td class="wrapper last">
                                    <?php
                                          ...
                                          if($_GET['status'] == 'In-transit'){
                                                $msg = '<h4>Your PO#: '.$_GET['ponumber'].' is now in Transit to the Philippines.</h4>';
                                          }
                                          elseif($_GET['status'] == 'Customs Clearing'){
                                                $msg = '<h4>Your PO#:  '.$_GET['ponumber'].' has arrived and is now undergoing customs clearing.</h4>';
                                          }
                                          elseif($_GET['status'] == 'Pickup'){
                                                $msg = '<h4>Your PO#:  '.$_GET['ponumber'].' has now been cleared through customs and is now waiting to be delivered.</h4>';
                                          }                                          
                                          elseif($_GET['status'] == 'Delivered'){
                                                $msg = '<h4>Your PO#:  '.$_GET['ponumber'].' has been delivered and received by MCD warehouse.</h4>';
                                          }
                                          echo $msg;
                                    ?>
                                                ...
                                                <td class="wrapper last">
                                                      ...
                                                      <tr>
                                                            <td>
                                                                  <h4>Details</h4>
                                                                  <p>
                                                                        Supplier: <?php echo $_GET['supplier']; ?>
                                                                  </p>
                                                                  <p>
                                                                        Order Date: <?php echo date('F d, Y',strtotime($_GET['order_date'])); ?>
                                                                  </p>
                                                                  <p>
                                                                        RQ # : <?php echo $_GET['rq_number']; ?> (<?php echo $_GET['rq_date']; ?>)
                                                                  </p>
                                                                  <p>
                                                                        Expected Delivery Date : <?php echo $_GET['expected_delivery']; ?>
                                                                  </p>
                                                            </td>
                                                            <td class="expander">
                                                            </td>
                                    ...
                                    <tr>
                                          <td class="panel">
                                                <a href="http://mlsvrimsv3:8008/ims/po/details/<?php echo $_GET['po_id']; ?>">
                                                http://mlsvrimsv3:8008/ims/po/details/<?php echo $_GET['po_id']; ?></a>
                                          </td>
                                          <td class="expander">
                                          </td>
                                    </tr>
