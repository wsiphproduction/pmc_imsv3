...
Route::get('/ims/login', 'Auth\LoginController@index');
...
Route::group(['middleware' => ['authenticated']], function () {
	...
	Route::get('/ims/receiving/drr-create/{waybill}/{po}', 'McdController@create')->name('create.drr');
...
## Create
	Route::get('/subjects/create', 'LogisticsController@create')->name('logistics.made');
	Route::post('/subjects/store', 'LogisticsController@store')->name('logistics.store');

## Update
   Route::get('/subjects/store/{id}', 'LogisticsController@edit')->name('logistics.edits');
   Route::post('/subjects/update/{id}', 'LogisticsController@update')->name('logistics.update');

## Delete
Route::get('/subjects/delete/{id}', 'LogisticsController@destroy')->name('logistics.delete');
